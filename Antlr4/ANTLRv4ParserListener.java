...
public interface ANTLRv4ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#postAtom}.
	 * @param ctx the parse tree
	 */
	void enterPostAtom(ANTLRv4Parser.PostAtomContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#postAtom}.
	 * @param ctx the parse tree
	 */
	void exitPostAtom(ANTLRv4Parser.PostAtomContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#tokenRef}.
	 * @param ctx the parse tree
	 */
	void enterTokenRef(ANTLRv4Parser.TokenRefContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#tokenRef}.
	 * @param ctx the parse tree
	 */
	void exitTokenRef(ANTLRv4Parser.TokenRefContext ctx);
}